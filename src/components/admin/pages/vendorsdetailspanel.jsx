          ...
          <div className="card-admin-h">
            ...
            <div className="row">
              ...
              <div className="col-lg-12" onClick={downloadDocument}>
                ...
                <img src={pdf} className="img-fluid cursor-pointer" alt="document" />
            ...
            <div className="row">
              ...
              {singleVendor.portfolio_images && singleVendor.portfolio_images.length > 0 ? (
                ...
                <div className="col-lg-3">
                  <div className="card-upload">
                    <p className="label-title">No Portfolio Images Available</p>
                  </div>
                </div>
              )}
              <div className="col-lg-3">
