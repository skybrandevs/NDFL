          ...
          <div className="row">
            ...
            <div className="col-lg-8">
              ...
              <p className="careers-sentence">
                ...
                generous packages to make sure you feel respected and
            ...
            <div className="row">
              <div className="col-lg-6">
                ...
                <p className="careers-sentence-2">
                  Collaborate with skilled professionals on innovative projects,
                  fostering a supportive and creative work environment.
                </p>
              </div>
              <div className="col-lg-6">
                <img
                ...
                <p className="careers-sentence-2">
                  Build a stable career with a reputable company that values its
                  employees and offers long-term growth opportunities.
                </p>
              </div>
            </div>
